...
function starter_menu_tree($variables) {
...
*/
function starter_menu_link(array $variables) {
...
function starter_pager($variables) {
...
function starter_views_mini_pager($vars) {
  global $pager_page_array, $pager_total;
...
function starter_item_list($variables) {
